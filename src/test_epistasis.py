...
if __name__ == "__main__":
    ...
    individual = problem.toolbox.individual()
    problem.print_tree(individual, '../static/tree.png')
    baby_matrices, aggr_data_abs, aggr_data_v, aggr_data_mean, aggr_data_vm, ones, zeros, m_ones = problem.calculate_epistasis(individual, aggr='all', return_all=True)
    print('Aggr=absolute')
    print(aggr_data_abs)
    ...
    plt.savefig('../static/voting_mean.png', dpi=300)
    plt.show()
